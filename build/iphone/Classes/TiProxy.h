...
//Rare exceptions to indicate a bug in the _svgview_testapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for svgview_testapp proxies.
 */
