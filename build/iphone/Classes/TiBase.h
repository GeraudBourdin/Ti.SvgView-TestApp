...
// in simulator we redefine to format for svgview_testapp Developer console
...
{\
	NSString * exceptionName = [@"org.svgview_testapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.svgview_testapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIsvgview_testappNativeItemNone = -1, 
	UIsvgview_testappNativeItemSpinner = -2,
	UIsvgview_testappNativeItemProgressBar = -3,
	
	UIsvgview_testappNativeItemSlider = -4,
	UIsvgview_testappNativeItemSwitch = -5,
	UIsvgview_testappNativeItemMultiButton = -6,
	UIsvgview_testappNativeItemSegmented = -7,
	
	UIsvgview_testappNativeItemTextView = -8,
	UIsvgview_testappNativeItemTextField = -9,
	UIsvgview_testappNativeItemSearchBar = -10,
	
	UIsvgview_testappNativeItemPicker = -11,
	UIsvgview_testappNativeItemDatePicker = -12,
	
	UIsvgview_testappNativeItemInfoLight = -13,
	UIsvgview_testappNativeItemInfoDark = -14,
	
	UIsvgview_testappNativeItemDisclosure = -15,
	
	UIsvgview_testappNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all svgview_testapp instances of
