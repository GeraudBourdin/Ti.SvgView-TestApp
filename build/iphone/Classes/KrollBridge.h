...
@interface svgview_testappObject : KrollCoverageObject {
#else
@interface svgview_testappObject : KrollObject {
#endif
@private
...
extern NSString * svgview_testapp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	svgview_testappObject *_svgview_testapp;
    KrollObject* console;
	BOOL shutdown;
