...
/**
 The base class for all svgview_testapp modules
 */
...
/**
 svgview_testapp Platform calls this method on startup.
 */
-(void)startup;

/**
 svgview_testapp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 svgview_testapp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 svgview_testapp Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 svgview_testapp Platform calls this method on resume.
 @param sender The sender of the event.
 */
