...
/**
 Base class for all svgview_testapp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the svgview_testapp view hierarchy (such as wrapped iOS UIViews) was touched.
