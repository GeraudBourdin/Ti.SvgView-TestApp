...
//@interface svgview_testappObject : NSObject
//@end

@interface svgview_testappObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[svgview_testappObject class]])
		{
			for (NSString *key in [[(svgview_testappObject*)o modules] allKeys])
			{
